    ...
    with col_peta_perbandingan[0]:
        with st.container(border=True):
            try:
                ...
                # Aktual NDMI 2024 PNG
                img_2024_actual = Image.open("static/ndmi_2024.png")
                ...
                def rgba_to_classification(rgba_array):
                    ...
                    colors_rgb = {
                        (148, 137, 121): 0,  # very_low - biru
                        (255, 255, 224): 1,  # low - kuning muda
                        (173, 216, 230): 2,  # medium - orange
                        (0, 0, 139): 3,  # high - merah
                    }
