    ...
    with col2_peta:
        ...
        if option == "1999" or option == "2009":
            ...
            with st.container(border=True):
                ...
                st.info(
                    """
                    Hasil prediksi penutup lahan berbasis machine learning (Cellular Automata-Markov Chain dan XGBoost) menggunakan data:
                    - Klasifikasi penutup lahan metode supervised dari citra Landsat 5 TM, Landsat 7 ETM+, dan Landsat 8 OLI Surface Reflectance resolusi 30 meter tahun 1999, 2004, 2009, 2014, 2019, dan 2024 dari USGS.
